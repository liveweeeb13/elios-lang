...
class EliosInterpreter {
    constructor(debug = false) {
        ...
        this.functions = {
            ...
            'exit': this.handleExit.bind(this), // Ajout de la fonction exit
            ...
            'isPair': this.handleIsPair.bind(this),
            'isUnpair': this.handleIsUnpair.bind(this),
            ...
            'getContentFile': this.handleGetContentFile.bind(this),
    ...
    async processWhile(lines, startIndex) {
        ...
        while (this.evaluateCondition(condition) && iterationCount < maxIterations && !this.shouldExit) {
            // Réinitialiser les flags à chaque itération
            this.shouldBreak = false;
            this.shouldContinue = false;
            ...
            while (blockIndex < endWhileIndex && !this.shouldExit && !this.shouldBreak) {
                ...
                // Vérifier continue avant d'exécuter la ligne
                ...
                // Vérifier break après l'exécution
                if (this.shouldBreak) {
                    break;
                }
            }

            // Si break a été appelé, sortir de la boucle while
            if (this.shouldBreak) {
                break;
            }
        ...
        // Réinitialiser les flags après la boucle
        this.shouldBreak = false;
        this.shouldContinue = false;
